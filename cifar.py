...
def objective(trial, args):
    ...
    valid_accuracy, _ = run_model(trainloader=trainloader, validloader=validloader, epochs=args.epochs,
                                      ...
                                      learning_rate=learning_rate, momentum=momentum, num_filters=num_filters, fc1_size=fc1_size, fc2_size=fc2_size)
...
def run_model(trainloader, validloader, epochs, #use_rprop, 
